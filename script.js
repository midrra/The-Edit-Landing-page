...
const scriptURL =
  "https://script.google.com/macros/s/AKfycbzeYBI7df5zmnnEjke23CDS3hXSPe8mQ0A5yEjPuz1a2jBXZs3rLUB4PQGbe92yNv4f/exec";
...
console.log(utmSource, "the utmSource");

if (utmSource) {
  document.getElementById("utm_source_input").value = utmSource;
} else {
  document.getElementById("utm_source_input").value = "direct";
}
